...
@property (weak, nonatomic) IBOutlet UIImageView *monthImv;
@property (weak, nonatomic) IBOutlet UILabel *summaryLbl;
@property (weak, nonatomic) IBOutlet UIImageView *regBtn;
...
- (IBAction)RegClick:(id)sender {
    ...
    regViewcontroller.modalTransitionStyle=UIModalTransitionStyleCrossDissolve;
